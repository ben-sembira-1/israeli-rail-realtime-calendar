...
7.  Save the `.ics` file to the specified output directory using the `filename` specified in the config. _(Note: Code should be structured so the output directory can be passed as an argument, defaulting to the root directory for production)._
